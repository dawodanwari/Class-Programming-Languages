...
test(puzzle3, [fail, nondet]) :-
    solve(right,left,left,left,right,right,left,left).
test(puzzle3, [fail, nondet]) :-
    solve(right,right,left,left,right,right,left,left).
test(puzzle3, [fail, nondet]) :-
    solve(right,left,left,right,right,right,left,left).
test(puzzle3, [fail, nondet]) :-
    solve(right,left,left,left,left,left,left,left).
test(puzzle3, [fail, nondet]) :-
    solve(right,right,left,left,right,right,right,right).
test(puzzle3, [fail, nondet]) :-
    solve(right,left,left,right,right,right,left,left).
